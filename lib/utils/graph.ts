...
export class AddressGraph<
	K extends BlockAddr = BlockAddr,
	V extends BlockAddr = BlockAddr,
> extends AddressMap<AddressSet<V>, K> {
	static fromBasicBlocks<K extends BlockAddr, V extends BlockAddr>(
		basicBlocks: Map<K, unknown>,
	) {
